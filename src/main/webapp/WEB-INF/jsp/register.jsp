        ...
        <div class="card-body">
            ...
            <form:form action="/register" class="reg-form" modelAttribute="registerUser">
                ...
                <div class="row">
                    <!-- From Group -->
                    <div class="form-group col">
                        <form:input type="password" path="password_at" class="form-control form-control-lg" placeholder="Enter Password"/>
                         <form:errors path="password_at" class="text-white bg-danger"/>
                    </div>
                    <!-- End Of From Group -->
